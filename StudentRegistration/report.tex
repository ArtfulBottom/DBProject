...
Each foreign key constraint cascades deletion, so that if a course is removed all the associated students are unenrolled, and so that if a student is removed,
